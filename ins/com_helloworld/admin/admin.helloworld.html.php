 ...
 *  It will be called by code in the admin.helloworld.php file.
 *  
 ...
 * in the administrator/com_helloworld directory. Assuming the user's language is set as 'en-GB', this function will 
 * look in the administrator/language/en-GB directory for a file called 'en-GB.com_helloworld.ini'. Look in that
 * file and you will see rows of 'X=Y' types strings. In the example call above, 'HELLOWORLD' will be 'Hello World' 
 * (the parameter is converted to uppercase first) and the 'Y' value is what will be returned. Hence the example
 * function call will return 'Hello World'.
